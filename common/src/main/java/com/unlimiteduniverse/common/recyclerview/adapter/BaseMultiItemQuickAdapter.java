...
public abstract class BaseMultiItemQuickAdapter<F, T, K extends BaseViewHolder, V extends RecyclerView> extends BaseQuickAdapter<T, K, V> {
    ...
    public BaseMultiItemQuickAdapter(F fragment, V recyclerView, List<T> data) {
