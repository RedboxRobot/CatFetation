...
public abstract class BaseFetchLoadAdapter<T, K extends BaseViewHolder, V extends RecyclerView> extends RecyclerView.Adapter<K> implements IRecyclerView {
     ...
     */
    public BaseFetchLoadAdapter(V recyclerView, int layoutResId, List<T> data) {
