...
import com.unlimiteduniverse.common.recyclerview.entity.SectionEntity;
import com.unlimiteduniverse.common.recyclerview.holder.BaseViewHolder;

import java.util.List;

public abstract class BaseSectionQuickAdapter<T extends SectionEntity, K extends BaseViewHolder, V extends RecyclerView>
        extends BaseQuickAdapter<T, K, V> {
     ...
     */
    public BaseSectionQuickAdapter(V recyclerView, int layoutResId, int sectionHeadResId, List<T> data) {
