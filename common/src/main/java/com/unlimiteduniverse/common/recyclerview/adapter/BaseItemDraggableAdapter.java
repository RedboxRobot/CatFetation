...
import com.unlimiteduniverse.common.recyclerview.listener.OnItemDragListener;
import com.unlimiteduniverse.common.recyclerview.listener.OnItemSwipeListener;

import java.util.Collections;
import java.util.List;

public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder, V extends RecyclerView> extends BaseQuickAdapter<T, K, V> {
    ...
    public BaseItemDraggableAdapter(V recyclerView, List<T> data) {
        super(recyclerView, data);
    }

    public BaseItemDraggableAdapter(V recyclerView, int layoutResId, List<T> data) {
     ...
     * {@link .ItemDragAndSwipeCallback} to the Recycler when you enable
     * this.
     */
