...
import com.unlimiteduniverse.common.recyclerview.holder.RecyclerViewHolder;
...
public abstract class BaseMultiItemFetchLoadAdapter<F, T, K extends BaseViewHolder, V extends RecyclerView> extends BaseFetchLoadAdapter<T, K, V> {
    ...
    public BaseMultiItemFetchLoadAdapter(F fragment, V recyclerView, List<T> data) {
    ...
    protected void convert(final K baseHolder, final T item, final int position, boolean isScrolling) {
        ...
        if (h == null) {
            ...
            try {
                ...
                h = (RecyclerViewHolder) c.newInstance(new Object[]{this, fragment});
