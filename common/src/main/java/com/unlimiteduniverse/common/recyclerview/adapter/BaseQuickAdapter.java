...
import com.unlimiteduniverse.common.recyclerview.animation.AlphaInAnimation;
import com.unlimiteduniverse.common.recyclerview.animation.BaseAnimation;
import com.unlimiteduniverse.common.recyclerview.animation.ScaleInAnimation;
import com.unlimiteduniverse.common.recyclerview.animation.SlideInBottomAnimation;
import com.unlimiteduniverse.common.recyclerview.animation.SlideInLeftAnimation;
import com.unlimiteduniverse.common.recyclerview.animation.SlideInRightAnimation;
import com.unlimiteduniverse.common.recyclerview.entity.IExpandable;
import com.unlimiteduniverse.common.recyclerview.holder.BaseViewHolder;
import com.unlimiteduniverse.common.recyclerview.loadmore.LoadMoreView;
import com.unlimiteduniverse.common.recyclerview.loadmore.SimpleLoadMoreView;
import com.unlimiteduniverse.common.recyclerview.util.RecyclerViewUtil;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder, V extends RecyclerView>
        extends RecyclerView.Adapter<K> implements IRecyclerView {
     ...
     */
    public BaseQuickAdapter(V recyclerView, int layoutResId, List<T> data) {
    ...
    public BaseQuickAdapter(V recyclerView, List<T> data) {
