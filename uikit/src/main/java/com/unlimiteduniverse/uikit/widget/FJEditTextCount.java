package com.unlimiteduniverse.uikit.widget;
...
public class FJEditTextCount extends RelativeLayout {
     ...
     * @return
     */
    public FJEditTextCount setRegex(String rxgex) {
        setTextType(rxgex, MaxNum, etContent);
        return this;
    }
     ...
     * @param editText
     */
    private void setTextType(final String rxgex, final int maxLen, EditText editText) {
        InputFilter typeFilter = new InputFilter() {
            @Override
            public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart, int dend) {
                Pattern p = Pattern.compile(rxgex);
...
//                    }
        ...
        editText.setFilters(new InputFilter[]{typeFilter, filter});
    }
