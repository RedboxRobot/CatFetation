package com.unlimiteduniverse.uikit;
...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog setTitle(String title, SheetItemColor color) {
        showTitle = true;
        txt_title.setVisibility(View.VISIBLE);
        txt_title.setText(title);
        if (color == null) {
            txt_title.setTextColor(context.getResources().getColor(R.color.actionsheet_gray));
        } else {
    ...
    public ActionSheetDialog setCancelColor(SheetItemColor color) {
        if (color == null) {
    ...
    public enum SheetItemColor {
        Blue("#037BFF"), Red("#FD4A2E"), Black("#000000"), Grey("#999999"), PrintTheme("#05415C");
